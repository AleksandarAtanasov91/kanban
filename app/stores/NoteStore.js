...
class NoteStore {
  constructor() {
    //we call bindActions to map each action from Note Actions to a method by name
...
//connect the store to Alt using alt.createStore and assigning a label('NoteStore') to it
